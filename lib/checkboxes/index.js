          ...
          this.props.datas.map((data, idx) => {
            ...
            return (
              <Checkbox 
                ...
                label={data.label}
                checkedComponent={<Image source={pictoCheckedSource} style={this.props.pictoStyles ? this.props.pictoStyles.checked : styles.checkedPicto}></Image>}
                uncheckedComponent={<Image source={pictoUncheckedSource} style={this.props.pictoStyles ? this.props.pictoStyles.unchecked : styles.uncheckedPicto}></Image>}
